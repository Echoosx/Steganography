...
class LoginFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.passwordInput = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 200,25 ), wx.TE_PASSWORD )
		bSizer4.Add( self.passwordInput, 0, wx.ALL, 5 )
		...
		self.login = wx.Button( self, wx.ID_ANY, u"登录", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		...
		# Connect Events
		self.login.Bind( wx.EVT_BUTTON, self.loginEvent )
		self.m_button2.Bind( wx.EVT_BUTTON, self.registerShow )
